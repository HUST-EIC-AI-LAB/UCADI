...
from back_up.LWE_based_PHE.cuda_test import KeyGen
from back_up.encrypt_decrypt import encrypt, decrypt
   ...
   # scheduler_warmup = GradualWarmupScheduler(optimizer, multiplier=8, total_epoch=10, after_scheduler=scheduler_cosine)
    ...
    while True:
        ...
        if os.path.exists(name):
            ...
            decrypted_params = decrypt(sk, aggregation, shape_parameters)
        ...
        #update_name = train(name.split("/")[-1], device, train_data_loader, model, optimizer, log, warm_epoch, epoch, warmup_scheduler, train_scheduler)
        ...
        encrypt_params = encrypt(pk, diff_state)
